...
def load_mnist(section="training", offset=0, count=None, ret='xy',
    ...
    resources = {
        'training' : ['https://ossci-datasets.s3.amazonaws.com/mnist/train-images-idx3-ubyte.gz',
                      'https://ossci-datasets.s3.amazonaws.com/mnist/train-labels-idx1-ubyte.gz'],
        'testing' : ['https://ossci-datasets.s3.amazonaws.com/mnist/t10k-images-idx3-ubyte.gz',
